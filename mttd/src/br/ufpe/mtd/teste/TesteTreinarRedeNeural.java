...
public class TesteTreinarRedeNeural {
	...
	static void treinarRedeNeural() throws IOException{
		MTDFactory.getInstancia().newRedeNeuralControle().treinarRedeNeural();
	}
	 ...
	 * @throws Exception 
	 */
	static void inserirDocsParaAvaliacao() throws Exception{
...
//		listaDocs.add(doc.toDocument());
	...
	public static HashSet<String> carregarStopWords() throws IOException {
		File arquivo = MTDArquivoEnum.STOP_WORDS.getArquivo();
