...
import br.ufpe.mtd.util.analizers.ptstemmer.implementations.OrengoStemmer;
import br.ufpe.mtd.util.analizers.ptstemmer.implementations.PorterStemmer;
import br.ufpe.mtd.util.analizers.ptstemmer.implementations.RSLPSStemmer;
import br.ufpe.mtd.util.analizers.ptstemmer.implementations.SavoyStemmer;
import br.ufpe.mtd.util.analizers.ptstemmer.implementations.TruncStemmer;
import br.ufpe.mtd.util.analizers.ptstemmer.support.datastructures.LRUCache;
...
public abstract class Stemmer {
	...
	public enum StemmerType{ORENGO, PORTER, SAVOY,RSLPS,TRUNC};
	...
	public static Stemmer StemmerFactory(StemmerType stype) throws PTStemmerException
	{
		...
		case RSLPS:
			return new RSLPSStemmer();
		case TRUNC:
			return new TruncStemmer(0);
		default:
